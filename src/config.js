...
// Knockup: vertical launch speed = KNOCKUP_BASE * effectivePower
// Duration ~= 2 * launchSpeed / GRAVITY, so tuning these two controls airtime
// Low power (~6) at full HP: launchSpeed ~= 0.8*6 = 4.8, airtime ~= 0.48s
// High power (~10) at low HP (4x ratio): launchSpeed ~= 0.8*40 = 32, airtime ~= 3.2s
export const KNOCKUP_FACTOR = 0.8;

// Body collision
export const BODY_COLLISION_SPEED_THRESHOLD = 3; // min relative speed to trigger damage
export const BODY_COLLISION_DAMAGE_FACTOR = 0.5; // damage per unit of relative speed
export const BODY_COLLISION_KNOCKBACK_FACTOR = 0.15; // knockback per unit of relative speed
